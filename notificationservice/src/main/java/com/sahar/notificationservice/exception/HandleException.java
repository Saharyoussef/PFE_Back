package com.sahar.notificationservice.exception;
...
import static com.sahar.notificationservice.utils.RequestUtils.handleErrorResponse;
...
public class HandleException extends ResponseEntityExceptionHandler implements ErrorController {
    ...
    protected ResponseEntity<Object> handleExceptionInternal(Exception exception, Object body, HttpHeaders headers, HttpStatusCode statusCode, WebRequest webRequest) {
        ...
        return new ResponseEntity<>(RequestUtils.handleErrorResponse(exception.getMessage(), getRootCauseMessage(exception), request, statusCode), statusCode);
    }
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException exception, HttpHeaders headers, HttpStatusCode statusCode, WebRequest webRequest) {
        ...
        return new ResponseEntity<>(RequestUtils.handleErrorResponse(fieldsMessage, getRootCauseMessage(exception), request, statusCode), statusCode);
    }
    ...
    public ResponseEntity<Response> sQLIntegrityConstraintViolationException(SQLIntegrityConstraintViolationException exception) {
        ...
        return new ResponseEntity<>(RequestUtils.handleErrorResponse(exception.getMessage().contains("Duplicate entry") ? "Information already exists" : exception.getMessage(), getRootCauseMessage(exception), request, BAD_REQUEST), BAD_REQUEST);
    }
    ...
    public ResponseEntity<Response> badCredentialsException(BadCredentialsException exception) {
        ...
        return new ResponseEntity<>(RequestUtils.handleErrorResponse(exception.getMessage() + ": Incorrect email or password", getRootCauseMessage(exception), request, BAD_REQUEST), BAD_REQUEST);
    }
    ...
    public ResponseEntity<Response> apiException(ApiException exception) {
        ...
        return new ResponseEntity<>(RequestUtils.handleErrorResponse(exception.getMessage(), getRootCauseMessage(exception), request, BAD_REQUEST), BAD_REQUEST);
    }
    ...
    public ResponseEntity<Response> accessDeniedException(AccessDeniedException exception) {
        ...
        return new ResponseEntity<>(RequestUtils.handleErrorResponse("Access denied. You don't have access", getRootCauseMessage(exception), request, FORBIDDEN), FORBIDDEN);
    }
    ...
    public ResponseEntity<Response> exception(Exception exception) {
        ...
        return new ResponseEntity<>(RequestUtils.handleErrorResponse(processErrorMessage(exception), getRootCauseMessage(exception), request, INTERNAL_SERVER_ERROR), INTERNAL_SERVER_ERROR);
    }
    ...
    public ResponseEntity<Response> disabledException(DisabledException exception) {
        ...
        return new ResponseEntity<>(RequestUtils.handleErrorResponse("User account is currently disabled", getRootCauseMessage(exception), request, BAD_REQUEST), BAD_REQUEST);
    }
    ...
    public ResponseEntity<Response> duplicateKeyException(DuplicateKeyException exception) {
        ...
        return new ResponseEntity<>(RequestUtils.handleErrorResponse(processErrorMessage(exception), getRootCauseMessage(exception), request, BAD_REQUEST), BAD_REQUEST);
    }
